...
?>
        ...
        <header id="header" class="header py-28 text-center md:pt-36 lg:text-left xl:pt-44 xl:pb-32">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
                <div class="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
                    <h1 class="h1-large mb-5">Porque una buena referencia...</h1>
                    <p class="p-large mb-8">Puede salvar tu semestre además de proyectar tu carrera.</p>
                    <a class="btn-solid-lg" href="#your-link"><i class="fa fa-question-circle"></i> ¿Cómo?</a>
                    <a class="btn-solid-lg secondary" href="#your-link"><i class="fa fa-sign-in"></i>Inicia sesión</a>
                </div>
                <div class="xl:text-right">
                    <img class="inline" src="<?=MEDIA_URL?>home/images/header-smartphone.png" alt="alternative" />
                </div>
            ...
            <div class="container px-4 sm:px-8 xl:px-4">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="<?=MEDIA_URL?>home/images/features-icon-1.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="<?=MEDIA_URL?>home/images/features-icon-2.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="<?=MEDIA_URL?>home/images/features-icon-3.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="<?=MEDIA_URL?>home/images/features-icon-4.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="<?=MEDIA_URL?>home/images/features-icon-5.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="<?=MEDIA_URL?>home/images/features-icon-6.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
        ...
        <div id="details" class="pt-12 pb-16 lg:pt-16">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                ...
                <div class="lg:col-span-7">
                    <div class="xl:ml-14">
                        <img class="inline" src="<?=MEDIA_URL?>home/images/details-1.jpg" alt="alternative" />
                    </div>
                </div> <!-- end of col -->
            </div> <!-- end of container -->
        </div>
            ...
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                <div class="lg:col-span-7">
                    <div class="mb-12 lg:mb-0 xl:mr-14">
                        <img class="inline" src="<?=MEDIA_URL?>home/images/details-2.jpg" alt="alternative" />
                    </div>
                </div> <!-- end of col -->
                <div class="lg:col-span-5">
                    <div class="xl:mt-12">
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
                ...
                <div class="lg:col-span-8">
                    <div class="mb-12 text-center lg:mb-0 lg:text-left xl:mr-6">
                        <img class="inline rounded-lg" src="<?=MEDIA_URL?>home/images/details-lightbox.jpg" alt="alternative" />
                    </div>
                </div> <!-- end of col -->
        ...
        <div class="pt-16 pb-12">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                ...
                <div class="lg:col-span-7">
                    <div class="ml-14">
                        <img class="inline" src="<?=MEDIA_URL?>home/images/details-3.jpg" alt="alternative" />
                    </div>
                </div> <!-- end of col -->
            </div> <!-- end of container -->
        </div>
                    ...
                    <div class="swiper-container card-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="<?=MEDIA_URL?>home/images/testimonial-1.jpg" alt="alternative" />
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="<?=MEDIA_URL?>home/images/testimonial-2.jpg" alt="alternative" />
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="<?=MEDIA_URL?>home/images/testimonial-3.jpg" alt="alternative" />
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="<?=MEDIA_URL?>home/images/testimonial-4.jpg" alt="alternative" />
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="<?=MEDIA_URL?>home/images/testimonial-5.jpg" alt="alternative" />
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="<?=MEDIA_URL?>home/images/testimonial-6.jpg" alt="alternative" />
                                    <div class="card-body">
        ...
        <div id="download" class="basic-5">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2">
                <div class="mb-16 lg:mb-0">
                    <img src="<?=MEDIA_URL?>home/images/conclusion-smartphone.png" alt="alternative" />
                </div>
